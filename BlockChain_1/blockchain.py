...
class Blockchain(object):
    ...
    def valid_chain(self, chain):
        ...
        checking if a chain is valid by looping through each block and verifying both the hash and the proof.
        ...
        # Check that previous_hash of current chain and hash of previous chain are same
    ...
    def resolve_conflicts(self):
        ...
        # We're only looking for chains long than ours
...
def mine():
    ...
    # Forge the new Block ny adding it to the chain
